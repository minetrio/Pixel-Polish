        ...
        function c() {
            ...
            this.render = function() {
                ...
                r.attach("mousedown", i.rulers.obj, function() {
                    ...
                    i.guides.txt.nodeValue = pixPolishParams.hideGuides, P = 1, f(), b.close()
                    ...
                    i.rulers.txt.nodeValue = 1 === C ? pixPolishParams.hideRulers : pixPolishParams.showRulers, 0 < w ? (i.guides.obj.className = "", i.clear.obj.className = "", i.guides.txt.nodeValue = 1 === P ? pixPolishParams.hideGuides : pixPolishParams.showGuides) : (i.guides.obj.className = "disabled", i.clear.obj.className = "disabled"), s.style.display = 0 === a ? "inline-block" : "none", a = 1 - a
                })
