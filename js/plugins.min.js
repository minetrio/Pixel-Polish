...
/*!
 * TMPOINTER 
 * Custom mouse pointer for pixPolish Image Editor 
 */
! function(v) {
    "use strict";
...
var Event = function() {
    ...
    RulersGuides = function(r, d, u) {
        ...
        function p() {
            C = 1 - C;
            var e = document.getElementById("pixPolish-img-zoom-in"),
                t = document.getElementById("pixPolish-img-zoom-out");
            1 === C ? (t.click(), x.style.display = "block", v.style.display = "block", g.style.display = "block", document.getElementById("pixPolish-ruler-icon").classList.remove("closed"), function() {
                for (var e in E) E.hasOwnProperty(e) && n(E[e])
            }()) : (e.click(), document.getElementById("pixPolish-ruler-icon").classList.add("closed"), x.style.display = "none", v.style.display = "none")
        }
        ...
        function c() {
            ...
            this.render = function() {
                ...
                r.attach("mousedown", i.rulers.obj, function() {
                    ...
                    i.guides.txt.nodeValue = pixel - polishParams.hideGuides, P = 1, f(), b.close()
                }), s.appendChild(e), document.getElementById("pixPolish-ruler-icon").appendChild(k), document.getElementById("pixPolish-ruler-icon").appendChild(s), r.attach("mousedown", k, function() {
                    i.rulers.txt.nodeValue = 1 === C ? pixel - polishParams.hideRulers : pixel - polishParams.showRulers, 0 < w ? (i.guides.obj.className = "", i.clear.obj.className = "", i.guides.txt.nodeValue = 1 === P ? pixel - polishParams.hideGuides : pixel - polishParams.showGuides) : (i.guides.obj.className = "disabled", i.clear.obj.className = "disabled"), s.style.display = 0 === a ? "inline-block" : "none", a = 1 - a
                })
