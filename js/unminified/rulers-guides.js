...
var RulersGuides = function (evt, dragdrop, container) {
    ...
    var doc         = document.documentElement,
        ...
        toggleRulers = function () {
            ...
            var zoomIn = document.getElementById('pixPolish-img-zoom-in');
            var zoomOut = document.getElementById('pixPolish-img-zoom-out');
            ...
            if (rulerStatus === 1) {
                ...
                wrapper.style.display = 'block';
                document.getElementById('pixPolish-ruler-icon').classList.remove("closed");
                removeInboundGuides();
            } else {
                zoomIn.click();
                document.getElementById('pixPolish-ruler-icon').classList.add("closed");
        ...
        Menu = function () {
            var menuList = null,
                ...
                toggles = {},
                menuItemsList  = [{
                    'text': pixPolishParams.hideRulers,
                    'alias': 'rulers'
                }, {
                    'text': pixPolishParams.hideGuides,
                    'alias': 'guides'
                }, {
                    'text': pixPolishParams.clearAllGuides,
                    'alias': 'clear'
                }],
                i = 0;
            ...
            this.render = function () {
                ...
                evt.attach('mousedown', toggles.clear.obj, function () {
                    toggles.guides.txt.nodeValue = pixPolishParams.hideGuides;
                    guideStatus = 1;
                    deleteGuides();
                    menu.close();
                });
                ...
                document.getElementById('pixPolish-ruler-icon').appendChild(menuBtn);
                document.getElementById('pixPolish-ruler-icon').appendChild(menuList);

                evt.attach('mousedown', menuBtn, function () {
                    toggles.rulers.txt.nodeValue = (rulerStatus === 1)
                        ? pixPolishParams.hideRulers
                        : pixPolishParams.showRulers;
                    ...
                    if (guidesCnt > 0) {
                        ...
                        toggles.guides.txt.nodeValue = (guideStatus === 1)
                            ? pixPolishParams.hideGuides
                            : pixPolishParams.showGuides;
                    } else {
